...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="">
                    <span class="text-yellow-300">{{ $users->count()}}</span> Users
                </a>
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="">
                    <span class="text-green-300">{{ $movies->count()}}</span> Movies
                </a>
            </h2>
        </div>
        ...
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="https://tailwindcss.com/">
                    <span class="text-blue-300">{{ $series->count()}}</span> Series
                </a>
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900 dark:text-white">
              <span class="text-red-300">{{ $casts->count()}} </span>
              Casts
            </h2>
