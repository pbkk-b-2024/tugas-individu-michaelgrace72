...
<x-app-layout>
 <form action="{{ route('admin.seasons.store')}}" method="POST">
  ...
  <div class="border-b border-gray-900/10 pb-12">
      <h2 class="text-base font-semibold leading-7 text-gray-900">Add Season</h2>
  ...
  <div class="mt-6 flex items-center justify-end gap-x-6">
    <a href="{{ route('admin.seasons.index')}}" type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
